...
export function AppNavbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full px-8 py-4 flex items-center justify-between pointer-events-none bg-black backdrop-blur-md border-b border-[#282828]">
