  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Bottom scrim, sized to fully cover the text block so legibility
            doesn't depend on where the image happens to be dark. Fades to
            nothing well above that so the rest of the image stays untouched. */}
